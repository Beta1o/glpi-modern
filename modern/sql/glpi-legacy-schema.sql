...
CREATE TABLE `glpi_logs` (
  ...
  KEY `old_id` (`old_id`),
  KEY `new_id` (`new_id`)
) ENGINE=InnoDB AUTO_INCREMENT=838 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'glpi'
--
...
-- Dump completed on 2026-06-14  3:14:01
